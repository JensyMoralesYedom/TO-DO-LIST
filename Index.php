...
<html lang="en">
    ...
    <body>
        ...
        <br>    
        <div class="card">
            <div class="card-header">Lista de tareas (To Do List)</div>
            <div class="card-body">
    ...
    <li class="list-group-item ">            
        <form action="" method="post">
            ...
            <input
                ...
                &nbsp; <span class="float-start <?php echo ($registro['completado']==1)?'subrayado':''; ?>">&nbsp;<?php echo $registro['tarea'];?> </span><h6 class="float-start">
